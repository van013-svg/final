...
// Notice: In production setups, you should expand this mock GeoJSON array block to match the absolute 
// spatial boundary coordinate properties of Anhui, Hubei, Hunan, and Jiangsu to display properly!
    ...
    "features": [
        {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [[[116.5, 33.8], [117.8, 34.3], [118.3, 32.5], [119.5, 31.4], [118.2, 30.1], [116.6, 30.0], [116.5, 33.8]]]
            }
        },
        {
            "type": "Feature",
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [[[110.0, 32.5], [113.5, 31.8], [116.1, 31.5], [115.5, 29.8], [114.0, 29.8], [111.0, 30.0], [110.0, 32.5]]]
            }
        },
        {
            "type": "Feature",
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [[[110.0, 30.0], [113.0, 29.7], [114.1, 28.5], [113.8, 25.5], [111.5, 25.0], [109.5, 26.5], [110.0, 30.0]]]
            }
        },
        {
            "type": "Feature",
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [[[118.8, 34.6], [121.5, 34.3], [121.9, 31.8], [120.5, 31.0], [119.5, 31.4], [118.3, 32.5], [118.8, 34.6]]]
            }
        }
    ]
};
...
const map = L.map('map', {
    ...
    boxZoom: false,
    touchZoom: false
}).setView([31.0, 114.0], 4.5); // Recentered position to tightly bound the Yangtze cluster
...
function getColor(value, metric) {
    ...
    if (metric === 'pr_sum') {
        return value > 200 ? '#084594' : 
               value > 120 ? '#2171b5' :
               value > 60  ? '#4292c6' : 
               value > 15  ? '#9ecae1' : '#f7fbff';
    } else if (metric === 'pr_mean') {
        return value > 6   ? '#005a32' : 
               value > 4   ? '#41ab5d' : 
               value > 2   ? '#74c476' : 
               value > 0.5 ? '#c7e9c0' : '#f7fcf5';
    } else {
        return value > 12  ? '#4a148c' : 
               value > 8   ? '#7b1fa2' : 
               value > 4   ? '#9c27b0' : 
               value > 1.5 ? '#e040fb' : '#f3e5f5';
    }
}
...
// Cleaned up unused bottom button references to maintain console stability